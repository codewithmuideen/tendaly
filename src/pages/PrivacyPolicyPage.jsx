    ...
    <div className="bg-white font-sans">
      <div className="mx-auto max-w-4xl px-6 py-16 sm:py-24">
        ...
        <Section title="For California Residents (CCPA/CPRA)">
            ...
            <p>
                You can exercise these rights by emailing us at: <a href="mailto:privacy@tendaly.com" className="text-indigo-600 font-medium hover:underline">privacy@tendaly.com</a> or by visiting: <a href="" className="text-indigo-600 font-medium hover:underline">www.tendaly.com/privacy-requests</a>
            </p>
            <p>
