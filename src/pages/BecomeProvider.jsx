      ...
      <main>
        ...
        <section className="py-20 sm:py-28 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-bold text-indigo-900 font-serif">Your Platform for Success</h2>
        ...
        <section className="py-20 sm:py-28 bg-indigo-700">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white font-serif">Getting Started is Easy</h2>
            </div>
        ...
        <section className="py-20 sm:py-28 bg-slate-50">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold text-indigo-900 font-serif">Trusted by Providers Like You</h2>
                </div>
        ...
        <section className="py-20 sm:py-28 bg-white">
            <div className="container mx-auto px-6 max-w-3xl">
                <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold text-indigo-900 font-serif">Frequently Asked Questions</h2>
                </div>
